					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="card mb-3">
							...
							<div class="card-body" style="padding:10px">
								...
								<form name="form1" method="post" action="holiday-update.do">

								<table class="table table-bordered mytable-centermiddle" style="width:100%;">
									<tr>
										<td class="mycolor2" style="vertical-align:middle;width:60px">년도</td>
										<td>
											<input type="text" name="yyyy"  value="${holiday.yyyy }" class="form-control form-control-sm" style="width:60px" required>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="reason" value="${holiday.reason }" class="form-control form-control-sm" required>
										</td>
									</tr>
