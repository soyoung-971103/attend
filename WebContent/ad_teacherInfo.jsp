					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="card mb-3">
							<div class="card-header mycolor3" style="padding:10px">
								<h3><i class="fa fa-table"></i> 교수 입력</h3>
							</div>
								...
								<form name="form1" method="get" action="TeacherUpdate" enctype="multipart/form-data">
									...
									<table class="table table-bordered mytable-centermiddle" style="width:100%;">
										...
										<tr>
											...
											<td>
												<div class="form-inline">
													<input type="text" name="uid" value="${member.uid}" class="form-control form-control-sm" required>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-inline">
													<input type="text" name="pwd" value="${member.pwd}" class="form-control form-control-sm" required>
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" name="email" value="${member.email}" class="form-control form-control-sm">
											</td>
										</tr>
										<tr>
